  ...
  precise_building_services: [
    {
      ...
      slug: '/',
      sections: [
        TEMPLATES.precise_building_services[0],
        TEMPLATES.precise_building_services[1],
        TEMPLATES.precise_building_services[2],
        TEMPLATES.precise_building_services[3],
        TEMPLATES.precise_building_services[4],
        TEMPLATES.precise_building_services[5],
        TEMPLATES.precise_building_services[6],
        TEMPLATES.precise_building_services[7],
        TEMPLATES.precise_building_services[8],
        TEMPLATES.precise_building_services[9]
      ]
    },
    {
      name: 'Services',

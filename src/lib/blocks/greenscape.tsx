...
export { GS_SCHEMAS } from './greenscape.schemas';
        ...
        <div className="grid @lg:grid-cols-2 gap-10 @md:gap-16 items-center">
          <div className="relative">
            <div className="aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl relative z-10">
              <Image                 src={(image) || "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=800&q=80"}
      ...
      <div className="w-full max-w-7xl mx-auto px-6 @md:px-12">
        ...
        <div className="grid @md:grid-cols-2 @lg:grid-cols-4 gap-6">
          {projects?.map((p: any, i: number) => (
            ...
            >
              <Image                 src={(p.img) || "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=800&q=80"}

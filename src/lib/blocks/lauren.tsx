...
export { LW_SCHEMAS } from './lauren.schemas';
      ...
      <div className="w-full max-w-7xl mx-auto px-6 @md:px-12">
        <div className="grid @lg:grid-cols-2 gap-10 @md:gap-16 items-center">
          <div className="aspect-[4/5] rounded-lg overflow-hidden grayscale hover:grayscale-0 transition-all duration-700">
            <Image               src={(image) || "https://images.unsplash.com/photo-1519741497674-611481863552?w=800&q=80"}
          ...
          <div className="grid grid-cols-1 @md:grid-cols-3 gap-4">
            <div className="col-span-1 space-y-4">
              <div className="aspect-[4/3] overflow-hidden group relative">
                <Image                   src={(imgs?.[0]?.url) || "https://images.unsplash.com/photo-1519741497674-611481863552?w=800&q=80"}
              ...
              <div className="aspect-[4/5] overflow-hidden group relative">
                <Image                   src={(imgs?.[1]?.url) || "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=800&q=80"}
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  alt="Work"
                  referrerPolicy="no-referrer"
                fill />
            ...
            <div className="col-span-1">
              <div className="h-full min-h-[500px] overflow-hidden group relative">
                <Image                   src={(imgs?.[2]?.url) || "https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?w=800&q=80"}
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  alt="Work"
                  referrerPolicy="no-referrer"
                fill />
            ...
            <div className="col-span-1 space-y-4">
              ...
              <div className="aspect-[4/3] overflow-hidden group relative">
                <Image                   src={(imgs?.[3]?.url) || "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=800&q=80"}
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  alt="Work"
                  referrerPolicy="no-referrer"
                fill />

...
import { ArrowRight, Star, ChevronDown, Phone, Check, Award, CheckCircle, CheckCircle2, Scale } from 'lucide-react';

const BASE = '/work/sterling-law-group';

const PARTNERS = ["HARTWELL CAPITAL","MERIDIAN HOLDINGS","PINNACLE VENTURES","SUMMIT EQUITY"];
...
const REVIEWS = [{"name":"Rachel M.","rating":5,"source":"Google Review","text":"When our partnership dispute threatened to halt operations, James Sterling moved with incredible speed. They filed a counter-motion and resolved the issue, recovering full damages. Exceptional trial lawyers.","avatar":"https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=150&auto=format&fit=crop","dog":""},{"name":"David K.","rating":5,"source":"Google Review","text":"David Park guided us through a complex board restructuring. His corporate counsel was practical, strategic, and kept us fully compliant with state securities regulations.","avatar":"https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=150&auto=format&fit=crop","dog":""},{"name":"Tina R.","rating":5,"source":"Google Review","text":"David Park and his M&A team advised us on our asset acquisition. They uncovered a hidden valuation issue during due diligence that saved us millions. We won't close another deal without them.","avatar":"https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=150&auto=format&fit=crop","dog":""},{"name":"Marcus A.","rating":5,"source":"Google Review","text":"Sterling helped us negotiate a partnership buyout that was heading to litigation. Their commercial attorneys are sharp, practical, and highly strategic.","avatar":"https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=150&auto=format&fit=crop","dog":""}];
const FAQS = [{"q":"What types of matters does Sterling Law Group handle?","a":"We focus exclusively on high-value commercial, corporate, and estate matters. Our clients include public and private corporations, family offices, executives, and high-net-worth individuals. We do not practice personal injury, criminal defense, or general family law."},{"q":"How does your billing structure work?","a":"We offer hourly billing, fixed-fee arrangements for defined-scope engagements, and hybrid structures for complex litigation. All billing terms are established transparently in your engagement letter. You should never be surprised by your invoice."},{"q":"Do you handle cases outside of Tennessee?","a":"Yes. While we are headquartered in Nashville and primarily practice in Tennessee federal and state courts, we regularly handle matters in multiple jurisdictions and work with co-counsel across the country on complex multi-state disputes."},{"q":"How quickly can you respond to an urgent legal matter?","a":"We maintain 24-hour availability for existing clients on active matters. New urgent matters are reviewed by a senior partner within two business hours on weekdays, and same-day on weekends for true emergencies. Our size allows responsiveness large firms cannot match."},{"q":"What should I bring to our initial consultation?","a":"Relevant agreements, correspondence, corporate documents, and any prior legal filings. A clear written timeline of events is extremely helpful. We review everything before our meeting so our time together focuses entirely on strategy."}];
...
export default function SterlingLawGroupHome() {
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-8 text-left">
            ...
            <h1 className="font-sans font-black text-4xl sm:text-5xl xl:text-6xl tracking-tight leading-[1.05] text-white"
                dangerouslySetInnerHTML={{ __html: `Justice,<br />argued<br /><span class="text-[#C9A84C] italic font-light font-serif">brilliantly.</span>` }} />
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <Link 
                href={`${BASE}/contact`}
                className="bg-yellow-400 text-slate-950 hover:bg-yellow-500 font-sans font-black uppercase text-xs tracking-widest px-8 py-4 rounded-xl shadow-lg flex items-center justify-center gap-2 group transition-all"
              >
                Book Appointment
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="relative aspect-[4/3] sm:aspect-[16/10] lg:aspect-[4/5] rounded-[32px] overflow-hidden border border-slate-800 shadow-2xl">
              <Image 
                ...
                alt="Sterling Law Group Hero Showcase"
            ...
            {SERVICES.map((item, idx) => (
              ...
              >
                ...
                <div className="relative mt-auto p-6 space-y-4 text-left z-10 text-white">
                  <span className="inline-block text-[10px] font-black uppercase tracking-widest text-yellow-400 bg-white/10 px-3 py-1 rounded-full backdrop-blur-sm border border-white/10">
                    Premium Service
                  </span>
                  ...
                  <Link 
                    href={`${BASE}/services`}
                    className="inline-flex items-center gap-2 text-xs font-bold text-yellow-400 group-hover:underline"
                  >
              ...
              {PROMISES.length > 0 ? (
                PROMISES.map((item: any, idx: number) => {
                  ...
                  return (
                    <div key={idx} className="flex gap-4 items-start text-left">
                      <div className="w-6 h-6 rounded-full bg-slate-900 flex items-center justify-center text-yellow-400 shrink-0 mt-0.5">
                ...
                [
                  ...
                  <div key={idx} className="flex gap-4 items-center">
                    <div className="w-6 h-6 rounded-full bg-slate-900 flex items-center justify-center text-yellow-400 shrink-0">
                      <Check className="w-3.5 h-3.5 stroke-[3]" />
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {LISTINGS.map((item: any, idx: number) => (
                <div key={idx} className="group relative rounded-[28px] overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-slate-100 flex flex-col h-[420px]">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/40 to-transparent opacity-85" />
                  <div className="relative mt-auto p-6 space-y-4 text-left z-10 text-white">
                    <span className="inline-block text-[10px] font-black uppercase tracking-widest text-yellow-400 bg-white/10 px-3 py-1 rounded-full backdrop-blur-sm border border-white/10">{item.price}</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {PRODUCTS.map((item: any, idx: number) => (
                <div key={idx} className="group relative rounded-[28px] overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-slate-100 flex flex-col h-[420px]">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/40 to-transparent opacity-85" />
                  <div className="relative mt-auto p-6 space-y-4 text-left z-10 text-white">
                    <span className="inline-block text-[10px] font-black uppercase tracking-widest text-yellow-400 bg-white/10 px-3 py-1 rounded-full backdrop-blur-sm border border-white/10">{item.tag || 'New'}</span>
                    <h4 className="font-sans font-black text-xl leading-none text-white">{item.name}</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {TECH.map((item: any, idx: number) => (
                <div key={idx} className="bg-slate-50 border border-slate-200/60 p-8 rounded-3xl text-left">
                  <div className="w-10 h-10 rounded-xl bg-slate-900 flex items-center justify-center text-yellow-400 mb-6"><CheckCircle2 className="w-5 h-5" /></div>
      ...
      <section className="bg-slate-950 text-white py-24 px-6 md:px-12 relative overflow-hidden border-b border-slate-900">
        ...
        <div className="max-w-7xl mx-auto space-y-16 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 text-left">
            <div className="space-y-4">
              <h2 className="text-xs font-black uppercase tracking-[0.2em] text-yellow-400">
            ...
            <Link 
              href={`${BASE}/reviews`}
              className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest text-yellow-400 hover:underline shrink-0"
            >
              ...
              >
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-slate-800/80 mt-auto">
                  ...
                  <div className="leading-tight">
                    ...
                    <div className="text-[9px] text-yellow-400 font-mono tracking-wider mt-0.5">{r.dog || r.source}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 px-6 bg-slate-950 text-white text-center border-t border-slate-900">
        <div className="max-w-3xl mx-auto space-y-8">
          <h2 className="font-sans font-black text-3xl md:text-5xl leading-tight text-white">Begin your case today.</h2>
          <p className="text-slate-400 text-sm max-w-md mx-auto leading-relaxed">A senior partner is available for an initial consultation. Confidential. Candid. No obligation.</p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href={`${BASE}/contact`} className="bg-yellow-400 text-slate-950 hover:bg-yellow-500 font-sans font-black uppercase text-xs tracking-widest px-8 py-4 rounded-xl shadow-lg flex items-center justify-center gap-2 group transition-all">
              Book Your Appointment <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
            </Link>
            <a href="tel:6155550190" className="flex items-center justify-center gap-3 px-6 py-4 rounded-xl border border-slate-800 hover:bg-slate-900/60 transition-all font-bold text-sm text-white">
              <Phone className="w-5 h-5 text-yellow-400" /> (615) 555-0431
            </a>
          </div>
        </div>
      </section>

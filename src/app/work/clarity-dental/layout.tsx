        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <div className="text-xs font-bold uppercase tracking-widest" style={{ color: BLUE }}>New Patients Welcome</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="mt-5 text-xs font-bold" style={{ color: BLUE }}>Emergency appointments available</div>
            </div>
            <div>
              ...
              <div className="space-y-4 text-[11px] text-white/45">
                <div className="flex gap-3"><MapPin className="w-3.5 h-3.5 shrink-0 mt-0.5" style={{ color: BLUE }} /><span>525 Medical Center Blvd<br />Denver, CO 80220</span></div>
                <div className="flex gap-3"><Phone className="w-3.5 h-3.5 shrink-0" style={{ color: BLUE }} /><span>(720) 555-0183</span></div>
                <div className="flex gap-3"><Mail className="w-3.5 h-3.5 shrink-0" style={{ color: BLUE }} /><span>hello@claritydental.com</span></div>
              </div>
            </div>
          </div>

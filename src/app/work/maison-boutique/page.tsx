...
const LISTINGS = [];
const PRODUCTS = [{"img":"https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=800&auto=format&fit=crop&q=80","name":"Linen Wrap Dress","price":"$148","tag":"New"},{"img":"https://images.unsplash.com/photo-1581044777550-4cfa60707c03?w=800&auto=format&fit=crop&q=80","name":"Tailored Blazer","price":"$224","tag":"Back in Stock"},{"img":"https://images.unsplash.com/photo-1554568218-0f1715e72254?w=800&auto=format&fit=crop&q=80","name":"Silk Midi Skirt","price":"$176","tag":"Best Seller"},{"img":"https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=800&auto=format&fit=crop&q=80","name":"Cotton Knit Top","price":"$96","tag":"New"}];
const TECH = [];
const ACHIEVEMENTS = [];
const BREEDS = [];

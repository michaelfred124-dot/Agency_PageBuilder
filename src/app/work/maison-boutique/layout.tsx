...
const italiana = Italiana({ subsets: ['latin'], weight: ['400'], variable: '--font-display', display: 'swap' });
const josefin = Josefin_Sans({ subsets: ['latin'], weight: ['300','400','600','700'], variable: '--font-body', display: 'swap' });
...
export default function MaisonLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className={`${italiana.variable} ${josefin.variable} min-h-screen text-gray-800`} style={{ backgroundColor: SAND, fontFamily: 'var(--font-body)' }}>
      <MBNav />
      <main>{children}</main>
      <footer style={{ backgroundColor: ESPRESSO }} className="text-white pt-14 pb-8 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-10 mb-10">
            <div>
              <div className="flex items-center gap-2 mb-5">
                ...
                <span className="italic text-xl tracking-wider" style={{ fontFamily: 'var(--font-display)', color: SAND }}>Maison</span>
              </div>
              <p className="text-white/45 text-sm leading-relaxed mb-5" style={{ fontFamily: 'var(--font-body)' }}>Curated women's fashion. Nashville, TN. New arrivals every Thursday. Thoughtfully selected, sustainably sourced.</p>
              <div className="flex gap-4">
                <a href="#" className="text-white/30 hover:text-white transition-colors"><Instagram className="w-4 h-4" /></a>
              </div>
            </div>
            <div>
              <h4 className="text-[9px] font-bold uppercase tracking-[0.3em] text-white/25 mb-5" style={{ fontFamily: 'var(--font-body)' }}>Shop</h4>
            ...
            <div>
              <h4 className="text-[9px] font-bold uppercase tracking-[0.3em] text-white/25 mb-5" style={{ fontFamily: 'var(--font-body)' }}>Store Hours</h4>
              <div className="space-y-2 text-[11px] text-white/45" style={{ fontFamily: 'var(--font-body)' }}>
              ...
              <div className="mt-5 text-xs font-bold" style={{ color: SAGE, fontFamily: 'var(--font-body)' }}>Free shipping on orders $75+</div>
            </div>
            <div>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-[9px] text-white/20 uppercase tracking-widest" style={{ fontFamily: 'var(--font-body)' }}>© 2026 Maison Boutique · Nashville, TN · Dressed for Your Story</p>
            <Link href={`${BASE}/contact`} className="text-[9px] text-white/20 hover:text-white uppercase tracking-widest transition-colors" style={{ fontFamily: 'var(--font-body)' }}>Visit the Store</Link>
          </div>
        </div>
      </footer>
    </div>

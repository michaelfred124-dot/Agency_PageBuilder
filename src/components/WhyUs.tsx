    ...
    <section className="py-20 lg:py-32 bg-[#F7F8FA] px-4 lg:px-6 relative overflow-hidden border-t border-zinc-200/50 z-10">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16 px-4">
          <h2 className="text-4xl md:text-6xl font-extrabold uppercase tracking-tight text-zinc-950">
            The <span style={{ color: COLORS.green }}>Real</span> Cost
          </h2>
          <p className="text-base md:text-lg text-zinc-600 font-normal max-w-2xl mx-auto mt-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto auto-rows-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="col-span-1 bg-white border-2 border-zinc-950 rounded-3xl overflow-hidden shadow-[4px_4px_0px_rgba(9,9,11,1)] flex flex-col relative group hover:-translate-y-1 transition-transform duration-300"
          >
            <div className="h-48 overflow-hidden border-b-2 border-zinc-950 relative">
              <img 
              ...
              <div className="absolute top-4 left-4 z-10">
                 <span className="text-[10px] border-2 border-zinc-950 rounded-full px-3 py-1 bg-white text-zinc-950 tracking-widest uppercase font-bold shadow-[2px_2px_0px_rgba(9,9,11,1)]">Wix / SqSpace</span>
              </div>
            </div>
            <div className="p-8 flex flex-col flex-grow">
              <div className="mb-6 relative z-10">
                ...
                <p className="text-zinc-500 text-sm font-normal mt-2">Cheap upfront, but you pay with your time.</p>
              </div>
              <ul className="space-y-4 relative z-10 mb-8">
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-red-50 flex items-center justify-center shrink-0 border border-red-500 mt-0.5">
                    <X className="w-3 h-3 text-white" strokeWidth={4} />
                  </div>
                  <span className="font-semibold text-zinc-700 text-sm">You do all the work & design</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-red-50 flex items-center justify-center shrink-0 border border-red-500 mt-0.5">
                    <X className="w-3 h-3 text-white" strokeWidth={4} />
                  </div>
                  <span className="font-semibold text-zinc-700 text-sm">Cookie-cutter templates</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-red-50 flex items-center justify-center shrink-0 border border-red-500 mt-0.5">
                    <X className="w-3 h-3 text-white" strokeWidth={4} />
                  </div>
                  <span className="font-semibold text-zinc-700 text-sm">You don't actually own the code</span>
                </li>
              </ul>
              
              <button 
                onClick={() => setIsDiyModalOpen(true)}
                className="mt-auto flex items-center gap-2 justify-center w-full py-2.5 px-4 border-2 border-zinc-950 rounded-full font-semibold uppercase tracking-wider text-xs hover:bg-zinc-950 hover:text-white transition-colors cursor-pointer"
              >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-8 relative z-10">
              <div>
                <div className="inline-block px-4 py-1.5 border-2 border-zinc-950 rounded-full bg-white text-zinc-950 text-xs font-extrabold uppercase tracking-widest mb-4 shadow-[2px_2px_0px_rgba(9,9,11,1)]">
                  Our Subscription
                </div>
                <h3 className="text-3xl md:text-4xl font-extrabold uppercase tracking-tight text-zinc-950">
                  Websites <br className="hidden md:block" />never been easier
                </h3>
              </div>
              <div className="text-left sm:text-right">
                <div className="text-5xl font-black tracking-tight text-zinc-950">$50</div>
                <div className="text-zinc-800 font-bold uppercase tracking-wider text-xs">Upfront Cost</div>
              </div>
            </div>
          ...
          >
            <div className="h-48 overflow-hidden border-b-2 border-zinc-950 relative">
              ...
              />
              <div className="absolute top-4 left-4 z-10">
                 <span className="text-[10px] border-2 border-zinc-950 rounded-full px-3 py-1 bg-white text-zinc-950 tracking-widest uppercase font-bold shadow-[2px_2px_0px_rgba(9,9,11,1)]">Traditional</span>
              </div>
            </div>
            <div className="p-8 flex flex-col flex-grow">
              <div className="mb-6 relative z-10">
                ...
                <p className="text-zinc-500 text-sm font-normal mt-2">Huge upfront costs and slow turnaround times.</p>
              </div>
              <ul className="space-y-4 relative z-10">
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-semibold text-zinc-700 text-sm">$5k - $20k+ Upfront Cost</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-red-50 flex items-center justify-center shrink-0 border border-red-500 mt-0.5">
                    <X className="w-3 h-3 text-white" strokeWidth={4} />
                  </div>
                  <span className="font-semibold text-zinc-700 text-sm">Takes 2-4 Months to Launch</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-red-50 flex items-center justify-center shrink-0 border border-red-500 mt-0.5">
                    <X className="w-3 h-3 text-white" strokeWidth={4} />
                  </div>
                  <span className="font-semibold text-zinc-700 text-sm">Charge hourly for minor specific edits</span>
                </li>
              </ul>
            </div>
          </motion.div>
        ...
        {isDiyModalOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-2xl bg-white border-2 border-zinc-950 rounded-3xl p-8 shadow-[6px_6px_0px_rgba(9,9,11,1)] flex flex-col max-h-[90vh] overflow-y-auto overflow-x-hidden"
            >
              <button 
                onClick={() => setIsDiyModalOpen(false)}
                className="absolute top-6 right-6 w-8 h-8 border-2 border-zinc-950 rounded-full flex items-center justify-center bg-white hover:bg-zinc-950 hover:text-white shadow-[2px_2px_0px_rgba(9,9,11,1)] transition-colors cursor-pointer"
              >
                <X className="w-4 h-4 text-zinc-950 hover:text-white" strokeWidth={3} />
              </button>

              <div className="mb-8 pr-12">
                <h3 className="text-2xl lg:text-3xl font-extrabold uppercase tracking-tight text-zinc-950 leading-tight">
                  Why DIY Builders Fall Short <br/><span className="text-red-500">for Small Businesses</span>
                </h3>
              </div>

              <div className="space-y-6">
                <div className="bg-zinc-50 border-2 border-zinc-950 p-6 rounded-2xl shadow-[3px_3px_0px_rgba(9,9,11,1)]">
                  <h4 className="text-lg font-bold uppercase tracking-tight text-zinc-950 mb-2 flex items-center gap-2">

...
export default function WhyUs() {
  ...
  return (
    <section className="py-20 lg:py-32 bg-[#FAFAFA] px-4 lg:px-6 relative overflow-hidden border-t border-black/5 z-10">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16 px-4">
          <h2 className="text-4xl md:text-6xl font-extrabold uppercase tracking-tight text-[#1a1a1a]">
            The <span className="text-[#FF7F11]">Real</span> Cost
          </h2>
          <p className="text-base md:text-lg text-[#1a1a1a]/60 font-normal max-w-2xl mx-auto mt-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto auto-rows-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="col-span-1 bg-white border border-black/8 rounded-3xl overflow-hidden shadow-lg flex flex-col relative group hover:-translate-y-1 transition-transform duration-300 cursor-pointer"
          >
            <div className="h-48 overflow-hidden border-b border-black/8 relative">
              <img 
              ...
              <div className="absolute top-4 left-4 z-10">
                 <span className="text-[10px] border border-white/20 rounded-full px-3 py-1 bg-black/60 backdrop-blur-sm text-white tracking-widest uppercase font-bold shadow-lg">Wix / SqSpace</span>
              </div>
            </div>
            <div className="p-8 flex flex-col flex-grow">
              <div className="mb-6 relative z-10">
                ...
                <p className="text-[#1a1a1a]/40 text-sm font-normal mt-2">Cheap upfront, but you pay with your time.</p>
              </div>
              <ul className="space-y-4 relative z-10 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-semibold text-[#1a1a1a]/70 text-sm">You do all the work & design</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-red-500/10 flex items-center justify-center shrink-0 border border-red-500/30 mt-0.5">
                    <X className="w-3 h-3 text-red-500" strokeWidth={4} />
                  </div>
                  <span className="font-semibold text-[#1a1a1a]/70 text-sm">Cookie-cutter templates</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-red-500/10 flex items-center justify-center shrink-0 border border-red-500/30 mt-0.5">
                    <X className="w-3 h-3 text-red-500" strokeWidth={4} />
                  </div>
                  <span className="font-semibold text-[#1a1a1a]/70 text-sm">You don't actually own the code</span>
                </li>
              </ul>
          ...
          <motion.div
            ...
            style={{ 
              ...
              backgroundImage: `linear-gradient(to right, rgba(212, 175, 55, 0.08) 1.5px, transparent 1.5px), linear-gradient(to bottom, rgba(212, 175, 55, 0.08) 1.5px, transparent 1.5px)`,
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-8 relative z-10">
              <div>
                ...
                <h3 className="text-3xl md:text-4xl font-extrabold uppercase tracking-tight text-[#1a1a1a]">
                  Websites <br className="hidden md:block" />never been easier
                </h3>
              </div>
              <div className="text-left sm:text-right">
                <div className="text-5xl font-black tracking-tight text-[#1a1a1a]">$50</div>
                <div className="text-[#1a1a1a]/60 font-bold uppercase tracking-wider text-xs">Upfront Cost</div>
              </div>
            </div>
            ...
            <div className="flex-grow grid sm:grid-cols-2 gap-8 items-center relative z-10">
              ...
              <ul className="space-y-3.5">
                {[
                  ...
                  <li key={index} className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-sm text-[#1a1a1a]">{benefit}</span>
                  </li>
                ))}
              </ul>
              ...
              <div className="flex justify-center sm:justify-end">
                <div className="w-full max-w-[340px] aspect-[4/3] bg-white border border-black/10 rounded-2xl overflow-hidden shadow-2xl hover:-translate-y-1 transition-all duration-300">
                  <img 
            ...
            <div className="mt-10 pt-8 border-t border-black/10 relative z-10 flex justify-center text-center">
              <Link 
                href="/pricing" 
          ...
          >
            <div className="h-48 overflow-hidden border-b border-black/8 relative">
              ...
              />
              <div className="absolute top-4 left-4 z-10">
                 <span className="text-[10px] border border-white/20 rounded-full px-3 py-1 bg-black/60 backdrop-blur-sm text-white tracking-widest uppercase font-bold shadow-lg">Traditional</span>
              </div>
            </div>
            <div className="p-8 flex flex-col flex-grow">
              <div className="mb-6 relative z-10">
                ...
                <p className="text-[#1a1a1a]/40 text-sm font-normal mt-2">Huge upfront costs and slow turnaround times.</p>
              </div>
              <ul className="space-y-4 relative z-10">
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-semibold text-[#1a1a1a]/70 text-sm">$5k - $20k+ Upfront Cost</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-red-500/10 flex items-center justify-center shrink-0 border border-red-500/30 mt-0.5">
                    <X className="w-3 h-3 text-red-500" strokeWidth={4} />
                  </div>
                  <span className="font-semibold text-[#1a1a1a]/70 text-sm">Takes 2-4 Months to Launch</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-red-500/10 flex items-center justify-center shrink-0 border border-red-500/30 mt-0.5">
                    <X className="w-3 h-3 text-red-500" strokeWidth={4} />
                  </div>
                  <span className="font-semibold text-[#1a1a1a]/70 text-sm">Charge hourly for minor specific edits</span>
                </li>
              </ul>
            </div>
          </motion.div>
        ...
        {isDiyModalOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-2xl bg-white border border-black/10 rounded-3xl p-8 shadow-2xl flex flex-col max-h-[90vh] overflow-y-auto overflow-x-hidden text-[#1a1a1a]"
            >
              <button 
                onClick={() => setIsDiyModalOpen(false)}
                className="absolute top-6 right-6 w-8 h-8 border border-black/10 rounded-full flex items-center justify-center bg-[#FAFAFA] hover:bg-black hover:text-white transition-colors cursor-pointer"
              >
                <X className="w-4 h-4" strokeWidth={3} />
              </button>

              <div className="mb-8 pr-12">
                <h3 className="text-2xl lg:text-3xl font-extrabold uppercase tracking-tight text-[#1a1a1a] leading-tight">
                  Why DIY Builders Fall Short <br/><span className="text-red-500">for Small Businesses</span>
                </h3>
              </div>

              <div className="space-y-6">
                <div className="bg-[#FAFAFA] border border-black/8 p-6 rounded-2xl shadow-sm">
                  <h4 className="text-lg font-bold uppercase tracking-tight text-[#1a1a1a] mb-2 flex items-center gap-2">
                    <X className="w-5 h-5 text-red-500" strokeWidth={3} />
                    You Don't Own Your Asset
                  </h4>
                  <p className="text-[#1a1a1a]/50 text-sm font-normal">

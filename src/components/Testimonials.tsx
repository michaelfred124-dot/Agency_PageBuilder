...
export default function Testimonials() {
  return (
    <section className="py-20 lg:py-32 bg-white px-4 lg:px-6 border-t border-black/5 relative overflow-hidden">
      <AnimatedSquiggles />
          ...
          {TESTIMONIALS.map((t, i) => (
            ...
            >
              <div>
                ...
                <p className="text-base lg:text-lg font-medium leading-relaxed mb-8 mt-4 text-[#1a1a1a]">
                  "{t.quote}"
                </p>
              </div>
              <div className="flex items-center gap-4 border-t border-black/10 pt-6">
                ...
                <div>
                  <div className="font-extrabold uppercase tracking-wider text-xs text-[#1a1a1a]">{t.author}</div>
                  <div className="text-[#1a1a1a]/40 font-bold uppercase text-[10px] tracking-widest mt-1">{t.role}</div>
                </div>
              </div>
            </motion.div>
          ))}

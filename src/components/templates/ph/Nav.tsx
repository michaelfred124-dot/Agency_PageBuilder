    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 flex items-center justify-between h-[76px]">
          ...
          <Link href={BASE} className="flex items-center gap-3">
            ...
            <div className="leading-none text-left">
              <span className="font-sans font-black text-lg tracking-wider text-slate-900">VALLEY PROHOME</span>
              <div className="text-[9px] font-black uppercase tracking-[0.18em] text-slate-500 mt-1">Home Services & Contracting</div>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-4">
            <a href="tel:6155550301" className="hidden sm:flex items-center gap-2 text-xs font-bold text-slate-700 hover:text-slate-900 transition-colors">
      ...
      {open && (
        <div className="lg:hidden fixed inset-0 top-[76px] z-50 bg-white flex flex-col px-8 py-10 gap-6 animate-fade-in shadow-xl h-[calc(100vh-76px)]">
          ...
          <a href="tel:6155550301" className="flex items-center gap-3 text-lg font-bold text-slate-900">
            <Phone className="w-5 h-5 text-slate-900" />
            <span>(615) 555-0301</span>
          </a>

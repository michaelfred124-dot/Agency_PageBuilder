...
export default function ServicesOverview() {
  ...
  return (
    <section id="services" className="py-20 lg:py-32 bg-[#FAFAFA] px-6 relative overflow-hidden border-b border-black/5">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-16 lg:mb-24 gap-8 lg:gap-12">
          <div className="flex flex-col space-y-4">
            ...
            <h2 className="text-4xl md:text-6xl font-extrabold uppercase tracking-tight text-[#1a1a1a] leading-none">
              What We <br />Offer
            </h2>
          </div>
          <p className="max-w-xl text-[#1a1a1a]/60 text-base md:text-lg leading-relaxed font-normal">
          ...
          {services.map((skill, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-lg font-bold mb-3 text-[#1a1a1a]">
                  {skill.title}
                </h3>
                <p className="text-sm text-[#1a1a1a]/55 leading-relaxed font-normal">
                  {skill.description}
                </p>
              </motion.div>
            );
